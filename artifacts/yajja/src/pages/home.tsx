      ...
      {icons.map((Icon, i) => {
        ...
        return (
          <div
            ...
            style={{ top, left }}
          >
            <Icon className="h-4 w-4 text-[#2E2A7B]" />
          </div>
        );
      })}
    </div>
    ...
    <div className="min-h-screen bg-[#FFF7DA]">
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 pt-6 pb-6 max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl px-6 pt-6 pb-5 border border-[#F2D98B]">
            <div className="flex items-center justify-between mb-4">
              <div>
                <div className="flex items-center gap-1.5 text-[#2E2A7B]/70 text-sm mb-0.5">
                  <MapPin className="h-3.5 w-3.5" />
                  <span>Nairobi, Kenya</span>
                </div>
                <p className="text-[#2E2A7B] font-semibold text-lg">
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-[#2E2A7B]/70 hover:text-[#2E2A7B] hover:bg-[#FFF1B8] h-9 w-9"
                >
            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 rounded-2xl bg-[#FFF7DA] border-0 shadow-lg text-[#2E2A7B] placeholder:text-[#2E2A7B]/50"
                value={search}
      ...
      <div className="max-w-2xl mx-auto px-4 pt-2 pb-6">
        <h2 className="text-base font-bold text-[#2E2A7B] mb-4">What are you looking for?</h2>
            ...
            <Link key={cat.id} href={cat.href}>
              <div className="flex flex-col items-center gap-2 active:scale-95 transition-transform">
                <div className={`relative aspect-square w-full rounded-full overflow-hidden ${cat.bg} ring-4 ${cat.ring} shadow-lg flex items-center justify-center`}>
                  ...
                  <cat.Icon className="relative h-8 w-8 text-[#2E2A7B]" />
                </div>
                <span className="text-[11px] sm:text-xs font-semibold text-[#2E2A7B] text-center leading-tight">{cat.label}</span>
              </div>
            </Link>
          ))}
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 pb-8">
        <Link href="/shop">
          <div className="rounded-2xl bg-white border border-[#F2D98B] p-4 flex items-center gap-3 hover:bg-[#FFF7DA] transition-colors cursor-pointer shadow-sm">
            <div className="h-10 w-10 rounded-xl bg-[#FFF1B8] flex items-center justify-center">
              <ShoppingBag className="h-5 w-5 text-[#2E2A7B]" />
            </div>
            <div className="flex-1">
              <p className="font-bold text-sm text-[#2E2A7B]">Browse All Stores</p>
              <p className="text-xs text-[#2E2A7B]/60">All vendors in your area</p>
            </div>
            <ChevronRight className="h-5 w-5 text-[#2E2A7B]/40" />
          </div>
        </Link>
      </div>
    </div>
