...
export default function VendorProducts() {
  ...
  const handleSave = async () => {
    ...
    const data = { ...form, imageUrl, price: parseFloat(form.price) || 0, vendorId };
    if (editingProduct) {
  ...
  const isSaving = createProduct.isPending || updateProduct.isPending || isUploading;
  ...
  return (
    <div className="container max-w-3xl mx-auto py-8 px-4 space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-extrabold flex-1">My Menu</h1>
              ...
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="font-bold text-sm">{formatKES(p.price)}</span>
