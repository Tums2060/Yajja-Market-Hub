...
export const ordersTable = pgTable("orders", {
  ...
  disbursementReceipt: text("disbursement_receipt"),
  disbursementError: text("disbursement_error"),
  riderDisbursementStatus: text("rider_disbursement_status").notNull().default("pending"),
  riderDisbursementReceipt: text("rider_disbursement_receipt"),
  riderDisbursementError: text("rider_disbursement_error"),
